...
- Tier 2: digest-bound independent plan-review artifact, then operator-only `acai-plan-approved` plus its bot attestation; final exact-head independent Gate B is required.

For Tier 2, the independent plan-review comment must contain `Repository`, `Issue`,
